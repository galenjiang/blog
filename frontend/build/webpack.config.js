...
module.exports = {
  ...
  module: {
    rules: [
      {
        test: /\.(js|jsx)$/,
        include: /node_modules\/live-components/,
        use: [
          {
            loader: 'babel-loader',
          },
          ...
          ? ['style-loader',
            {
              ...
              options: {
                modules: true,
                sourceMap: true,
                localIdentName: '[local]___[path]___[name]__[hash:base64:5]',
              },
            },
  ...
  plugins: [
    new webpack.DefinePlugin({
      'process.env': {
        NODE_ENV: JSON.stringify(isServer() ? 'development' : 'production'),
        NODE_RUNTIME_ENV: JSON.stringify(process.env.NODE_RUNTIME_ENV),
      },
    }),
